        ...
        <div class="layui-row">
            <div class="layui-col-sm8">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" placeholder="请输入商品名" class="layui-input" value="<%=good.getGoods()%>">
                    </div>
                </div>
                <div class="layui-form-item" pane="">
                    <label class="layui-form-label">数量</label>
                    <div class="layui-input-block">
                        <input type="text" name="num" placeholder="请输入数量" class="layui-input" value="<%=good.getNum()%>">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="supplier" placeholder="请输入供货商" class="layui-input" value="<%=good.getSupplier()%>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
    ...
    layui.use(['form', 'laydate', 'upload'], function () {
        ...
        form.on('submit(ok)', function () {//单击添加按钮执行
            ...
            $.ajax({
                ...
                url: '<%=request.getContextPath()%>/UpdGoodsServlet',//提交给谁处理
                ...
                success: function (data) {//提交成功，将AddStu2Servlet处理后的返回值存储在data中
                    if (data.code == 1) {//判断返回值
                        layer.msg('商品信息修改成功', {icon: 5, time: 1000}, function () {//使用Jquery弹层组件，自动关闭
